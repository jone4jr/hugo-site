...
slug: "how-to-stop-firefighting"
url: "/how-to-stop-firefighting/"
aliases:
  - "/posts/how-to-stop-firefighting/"
date: 2026-06-01T09:15:00-04:00
category: "Operational Leadership"
tags: ["proactive leadership", "firefighting culture", "continuous improvement", "plant leadership", "daily management"]
description: "How to stop reactive firefighting, protect prevention work, and build a proactive culture that solves problems before they become emergencies."
summary: "A firefighting culture is not bad luck. It is a system that keeps rewarding reaction and starving prevention."
subtitle: "The goal is not to get better at handling crises. The goal is to build an operation that creates fewer of them."
faq:
  - question: "How do I stop firefighting at work?"
    answer: "Start by measuring how much of your effort is reactive versus proactive, protect prevention work from being consumed by emergencies, and make specific people responsible for catching and fixing recurring causes before they turn into crises."
  - question: "What is the difference between reactive and proactive leadership?"
    answer: "Reactive leadership solves problems once they are urgent. Proactive leadership builds systems, habits, and ownership that prevent those problems from becoming urgent in the first place."
  - question: "Why does my team keep putting out fires?"
...
Harvard Business Review has written directly about the need to [stop fighting fires](https://hbr.org/2000/07/stop-fighting-fires), but the deeper challenge is not tactical. It is cultural. People begin to measure value by crisis response. The best responders become heroes, while the quiet people preventing the next failure often get overlooked.
...
Plant Services makes the same point in its work on [moving from firefighting to a more planned environment](https://www.plantservices.com/cmms/article/11297161/3-maintenance-planning-tools-to-stop-firefighting). The shift toward proactive operations does not happen by wishing for calmer days. It happens when planning, maintenance, and management routines are intentionally rebuilt to make stability possible.
...
Protect prevention work. If preventive work can be pulled into the latest emergency every time pressure rises, then it is not truly staffed. It is hoped for. That is the same pattern I wrote about in [Under Pressure, People Default to Their Primary Job. Plan For It.](/posts/under-pressure-people-default-to-their-primary-job/).
...
FranklinCovey's work on [lead measures](https://mp.franklincovey.com/the-4-disciplines/discipline-2-act/) is useful here. Lag measures tell you whether you won after the fact. Lead measures create a way to influence the outcome while there is still time to change it.
...
- [Under Pressure, People Default to Their Primary Job. Plan For It.](/posts/under-pressure-people-default-to-their-primary-job/)
- [The Shift That Decides the Other Three](/posts/the-shift-that-decides-the-other-three/)
- [The Doom Loop: When Everyone Is Accountable and No One Is Responsible](/posts/the-doom-loop-accountable-responsible/)
